...
def words_to_imgs(wordlist=['raz', 'dwa', 'trzy'], font='', label='',
                  csv_name='', W=300, H=80):
    ...
    for word in wordlist:
        ...
        img = img.rotate(
            randint(-2, 2), resample=Image.BILINEAR,
            fillcolor="white", expand=0).resize([W, H])
...
if __name__ == "__main__":
    ...
    words_to_imgs(lato, "fonty/Lato-Regular.ttf", "Lato-Regular",
                  "testowe.csv")
    words_to_imgs(sans, "fonty/LiberationSans-Regular.ttf",
                  "LiberationSans-Regular", "testowe.csv")
    words_to_imgs(serif, "fonty/LiberationSerif-Regular.ttf",
                  "LiberationSerif-Regular", "testowe.csv")
